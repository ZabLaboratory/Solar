...
describe("resolveShowToken()", () => {
  ...
  it("preserves token characters that URLSearchParams round-trips (JWT dots/dashes)", () => {
    ...
    const orionUrl = `ws://127.0.0.1:4007/orion/api/v1/show/stream.lsdp?token=${jwt}`;

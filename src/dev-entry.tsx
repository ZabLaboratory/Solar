...
// harness can mount() Solar against a local mock LSDP server. Reads URL query
// params (orion / token / mode / scene / session), falls back to the embedded
// local Orion loopback endpoint, and mounts. The production counterpart is generated by
...
const orionUrl =
  params.get("orion") ?? "ws://127.0.0.1:4007/orion/api/v1/show/stream";
